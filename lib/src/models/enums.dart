...
enum CalendarSelectionMode {
  ...
  ///
  /// ![single_demo](https://github.com/dooboolab/flutter_calendar_widget/blob/main/doc/single_demo.gif)
  single,
  ...
  ///
  /// ![multiple_demo](https://github.com/dooboolab/flutter_calendar_widget/blob/main/doc/multiple_demo.gif)
  multiple,

  /// [CalendarSelectionMode.range], Allows to select a single range of
  /// dates.
  ///
  /// ![range_demo](https://github.com/dooboolab/flutter_calendar_widget/blob/main/doc/range_demo.gif)
  range,
}
